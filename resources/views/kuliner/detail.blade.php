...
<div class="main">
  <div class="wrap">
    <div class="row">
      ...
      <section class="three-fourth section-tour-content">
        <!--gallery-->
        <div>
          <img src="{{ $kuliner->gambar }}" alt="" style="width: 100%" />
        </div>
        <!--//gallery-->
        <!--inner navigation-->
        ...
        <section id="description" class="tab-content initial layout-above" style="display:none">
          <article>
            ...
            <div class="description">
              <div class="text-wrap">
                <p><strong>{{ $kuliner->lokasi }}</strong>
                </p>
                <p style="white-space: pre-wrap;">{{ $kuliner->deskripsi }}</p>
              </div>
            </div>
        ...
        <section id="itinerary" class="tab-content  layout-above" style="display:none">
          <article>
            ...
            <div id="kuliner-map" style="width: 100%; height: 420px; margin-bottom: 10px"></div>
            ...
            <div class="deals">
              <div class="row">
                ...
                <article data-tour-id="{{ $rekomendasi->id }}" class="tour_item full-width ">
                  <div><a href="/kuliner/{{ $rekomendasi->id }}" title="{{ $rekomendasi->nama }}">
                    ...
                    <div class="details hide-actions hide-description hide-rating ">
                      <div class='item-header'>
                        <h3><a href="/kuliner/{{ $rekomendasi->id }}"
                    ...
                    <!--//details--><a href="/kuliner/{{ $rekomendasi->id }}" class="overlay-link"></a>
                  </div>
                </article>
                @endforeach
                <!--//tour_item-->
  ...
  <script>
    function initMap() {
      ...
      var map = new google.maps.Map(document.getElementById('kuliner-map'), {
