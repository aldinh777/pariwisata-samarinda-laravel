...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 11, 2020 at 02:34 PM
...
INSERT INTO `kafe` (`id`, `nama`, `alamat`, `jam_buka`, `deskripsi`, `gambar`, `lat`, `lng`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `working_space` (`id`, `nama`, `alamat`, `jam_buka`, `deskripsi`, `gambar`, `lat`, `lng`, `created_at`, `updated_at`) VALUES
...
(2, 'Start-Up Coffee', 'Jl. Wahid Hasyim 2 No.25, Sempaja Sel., Kec. Samarinda Utara, Kota Samarinda, Kalimantan Timur 75131', '10.00–22.00', 'Mau Cari tempat buat kumpul-kumpul bareng temen-temen malam ini? Ke  Start Up Coffee aja yuk. Banyak menu yang harus kamu coba sambil baca buku-buku atau belajar bersama. Langsung aja yuk mampir sekarang...', '/img/workingspace/startup-coffee.jpg', 0, 0, NULL, NULL);
